...
<div class="container-top">
    <div class="main-img-top main-row" >
      ...
      <img class="top-book1" src="../static/images/h1-rev-img-01.png" alt="" />
      <img class="top-book2" src="../static/images/shop-img-08-600x525.png" alt="" />
      <img class="top-book3" src="../static/images/h1-rev-img-02.png" alt="" />
    </div>  
     
        <div style="margin:auto;"  class="column-40">  
...
<div class="product-title align-center">Newest Editions Out
...
<div class="parent">
  <div class="child"> <div class="container">
    <img style="height: 200px;" src="book.png" alt="" />
    
    <div class="overlay"></div>
    <div class="button"><a href="#"> ADD TO CART</a></div></div>
    <div class="product-title" style="font-size:22px;text-align: center;">Most Popular Edition</div>
